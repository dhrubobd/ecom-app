...
onMounted(() => {
    if (props.invoice) {
        form.payment_status = props.invoice.payment_status;
        form.delivery_status = props.invoice.delivery_status;
    }
});
</script>
                        ...
                        <div class="p-6 text-gray-900">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <select v-model="form.payment_status"
                                                ...
                                                <option v-for="option in payment_options" :value="option.value">
                                                    {{ option.text }}
                                                </option>
                                            </select>
                                        </div>
                                        <div>
                                            ...
                                            <select v-model="form.delivery_status"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 p-3">
                                                <option v-for="option in delivery_options" :value="option.value">
                                                    {{ option.text }}
                                                </option>
                                            </select>
                                        </div>
                            ...
                            <div class="bg-gray-50 p-6 rounded-lg mb-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p class="font-medium">{{ invoice.user?.user_name }}</p>
                                    </div>
                                    <div>
                                        <p class="text-sm text-gray-600">Phone</p>
                                        <p class="font-medium">{{ invoice.user?.user_phone }}</p>
                                    </div>
                                    <div class="md:col-span-2">
                                        <p class="text-sm text-gray-600">Address</p>
                                        <p class="font-medium">{{ invoice.user?.user_address }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-gray-50 p-6 rounded-lg mb-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <p class="text-sm text-gray-600">Name</p>
                                        <p class="font-medium">{{ invoice.user?.ship_name }}</p>
                                    </div>
                                    <div>
                                        <p class="text-sm text-gray-600">Phone</p>
                                        <p class="font-medium">{{ invoice.user?.ship_phone }}</p>
                                    </div>
                                    <div class="md:col-span-2">
                                        <p class="text-sm text-gray-600">Address</p>
                                        <p class="font-medium">{{ invoice.user?.ship_address }}</p>
                                    </div>
                                </div>
                            </div>
