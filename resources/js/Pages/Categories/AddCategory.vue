<script setup>
    ...
    const categoryImage = ref('https://placehold.co/100x100?text=Category+Image');
    ...
    <Mainlayout>
        ...
        <main class="ml-64 p-8">
            ...
            <form class="bg-white shadow-md rounded-lg p-6" @submit.prevent="submitForm">
                ...
                <div class="mb-4">
                    <img :src="categoryImage" alt="Category Image" class="w-25 h-25 rounded-full mb-2">
                </div>
                <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-md cursor-pointer">Add Category</button>
            </form>
        </main>
    </Mainlayout>
</template>
