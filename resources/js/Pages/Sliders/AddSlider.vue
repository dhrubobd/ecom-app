...
const slideImage = ref('https://placehold.co/100x100?text=Slide+Image');
    ...
    <Mainlayout>
        ...
        <main class="ml-64 p-8">
            ...
            <form class="bg-white shadow-md rounded-lg p-6" @submit.prevent="submitForm">
                ...
                <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-md cursor-pointer">Add Slide</button>
            </form>
        </main>
    </Mainlayout>
</template>
