...
const images = reactive({
    image: 'https://placehold.co/100x100?text=Product+Image',
    img1: 'https://placehold.co/100x100?text=Product+Image+1',
    img2: 'https://placehold.co/100x100?text=Product+Image+2',
    img3: 'https://placehold.co/100x100?text=Product+Image+3',
    img4: 'https://placehold.co/100x100?text=Product+Image+4',
});
        ...
        <div class="flex ">
            <main class="ml-64 p-8">
                ...
                <form class="bg-white shadow-md rounded-lg p-6" @submit.prevent="submitForm">
                    ...
                    <!-- Submit Button -->
                    <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-md cursor-pointer">Add Product</button>
                </form>
            </main>
        </div>
    </Mainlayout>
